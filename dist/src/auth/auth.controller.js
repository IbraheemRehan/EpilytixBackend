...
let AuthController = class AuthController {
    ...
    async login(loginDto, req) {
        return this.authService.login(loginDto.email, loginDto.password, req.ip, req.headers['user-agent']);
    }
    async verify2fa(verify2faDto, req) {
        return this.authService.verify2fa(verify2faDto.tempToken, verify2faDto.otp, req.ip, req.headers['user-agent']);
    }
